...
The script 'generate_bgq_data.py' creates the files 'bgq_links.yaml' and 'bgq_nodes.yaml' which contain the data for the meta file 'bgq_meta.yaml'.  The meta file itself is created by hand, without the use of a script.  
...
If any modifications are desired, see the method linkVal() in 'generate_bgq_data.py'.